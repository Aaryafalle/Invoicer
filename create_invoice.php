<?php 
   ...
   ?>
<title>Create New Invoice | Invoicer</title>
      ...
      <div class="load-animate animated fadeInUp">
         ...
         <div class="row">
            <div class="col-xs-12">
               ...
               <button class="btn btn-invoice" id="addRows" type="button">+ Add More</button>
            </div>
         </div>
         <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
               <h3>Notes: </h3>
               <div class="form-group">
                  <textarea class="form-control txt" rows="5" name="notes" id="notes" placeholder="Add Notes"></textarea>
               </div>
               <br>
               <div class="form-group">
